...
def start():
    ...
    attendance_taken = False  # Flag to check if attendance has been taken
    ...
    while ret:
        ...
        if len(extract_faces(frame)) > 0:
            ...
            attendance_taken = True  # Set the flag to True when attendance is taken

        if attendance_taken:
            cv2.putText(frame, 'Attendance taken, please press Esc to exit', (10, 30),
